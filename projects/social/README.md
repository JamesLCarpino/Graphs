...
100 \* 10 // 2 = 500, You need to do that because each time the friends are called it is added to both users, and it adds the friends and divides by 2 to handle the duplicating...

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
   1000 \* 5 // 2 = 2,500. so 25% of the friends would be in the users network. I'm guessing that the degree would be 5, because each user has 5 random friends.
